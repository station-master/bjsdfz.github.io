...
do
do
dm=inputbox(""&xt&" [版本 "&xx&"]"& Chr(13) & Chr(10) &"cmd - -v4.0 (c) Az Corporation。保留所有权利。"& Chr(13) & Chr(10) &""&getfolder&"\_",""&wscript.scriptfullname&"","")
...
msgbox "啊这将根据你输入的内容，打开相应的资源"& Chr(13) & Chr(10) &"输入“bz”获取帮助"& Chr(13) & Chr(10) &"输入 off 或 out 或 kill 或 quit 或 stop以关闭cmd--",,"关于"
msgbox bz,,"cmd--使用指南"
